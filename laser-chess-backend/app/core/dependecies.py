...
VERIFY_TOKEN_EXPIRE_MINUTES = int(get_env('VERIFY_TOKEN_EXPIRE_MINUTES', 60 * 24))
CHANGE_PASSWORD_TOKEN_EXPIRE_MINUTES = int(get_env('VERIFY_TOKEN_EXPIRE_MINUTES', 20))
...
VERIFY_MAIL_PORT = int(get_env('VERIFY_MAIL_PORT', 587))
