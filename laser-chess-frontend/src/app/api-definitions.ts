...
export const fullEndpoint = (endpoint: string, sub = ''): string =>
  `${environment.API_URL}${environment.API_PREFIX}${endpoint}${sub}`;
...
export const leaveLobbyFullEndpoint = (id = ''): string =>
  fullEndpoint(leaveLobbyEndpoint, id ? `/${id}` : '');
export const startGameFullEndpoint = fullEndpoint(startGameEndpoint);
export const friendsFullEndpoint = (id = ''): string =>
...
export const createLobbyFullEndpoint = (id = ''): string =>
  fullEndpoint(createLobbyEndpoint, id ? `/${id}` : '');
export const joinLobbyFullEndpoint = (id = ''): string =>
  fullEndpoint(joinLobbyEndpoint, id ? `/${id}` : '');
export const joinRandomLobbyFullEndpoint = (id = ''): string =>
  fullEndpoint(joinRandomLobbyEndpoint, id ? `/${id}` : '');
...
export const emailFullEndpoint = (id = ''): string =>
  fullEndpoint(emailEndpoint, id ? `/${id}` : '');
export const initialGameStateFullEndpoint = fullEndpoint(initialGameEndpoint);
export const gameHistoryFullEndpoint = (id = ''): string =>
  fullEndpoint(gameHistoryEndpoint, id ? `/${id}` : '');
